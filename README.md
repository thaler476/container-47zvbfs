...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-47zvbfs.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-47zvbfs.containers.anotherwebservice.com/
...
```
git clone git@github.com:thaler476/container-47zvbfs.git
cd container-47zvbfs
```
...
```
docker attach container-47zvbfs
```
